...
class ImageConvertConfirmModal extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <div className={"image-confirm-modal"}>
                    <Layout.Section>
                        <div className={'title'}>
                            <Heading element={"h1"}><CsI18n>Background removal confirmation</CsI18n></Heading>
                        </div>
                        <div className={'image-selected'}>
                            <span className={'select-title'}><CsI18n>You selected</CsI18n></span><br/>
                            <span className={'select-body'}>{CsI18n.t('{{count}} images', {count: count})}</span><br/>
                        </div>
                        ...
                        <div className={'image-agree'}>
                            <Checkbox label={CsI18n.t('I accept to be charged ${{total_price}} for background removal', {total_price})} checked={is_agree} onChange={this.handleAgreeCheck} />
                        </div>
...
export default ImageConvertConfirmModal;
